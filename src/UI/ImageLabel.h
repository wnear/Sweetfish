...
class ImageLabel : public QLabel {
    Q_OBJECT
  public:
    explicit ImageLabel(const unsigned int init_sizex = 0, const unsigned int init_sizey = 0, const unsigned int init_index = 0,
                        QString init_url = QString(), QWidget *parent = Q_NULLPTR, Qt::WindowFlags f = Qt::WindowFlags());

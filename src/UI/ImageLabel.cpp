...
ImageLabel::ImageLabel(const unsigned int init_sizex, const unsigned int init_sizey, const unsigned int init_index,
                       QString init_url, QWidget *parent, Qt::WindowFlags f)
    : QLabel(parent, f), index(init_index), sizex(init_sizex), sizey(init_sizey), url(init_url) {}
